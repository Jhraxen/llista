...
import yaml
import os
import Persistencia_factory_mySql, Persistencia_factory_redis, Persistencia_factory_sqlite
...
class Configurador:
    ...
    def get_Persistencia_factory(self):
        ...
        if motor == "mysql":
            ...
            ruta = self.config["base de dades"]["ruta"]
            return Persistencia_factory_sqite.Persistencia_factory_sqlite(
                ruta,
                self
            )
